...
if __name__ == '__main__':
    ...
    plt.scatter(true_val, df_slice['inferred_c0.1_treelength']/n_branch, label='inferred model ($c=0.1$)')
    # plt.scatter(true_val, df_slice['inferred_c1.0_treelength']/n_branch, label='c=1.0')
    plt.scatter(true_val, df_slice['trueRates_c0.1_treelength']/n_branch, label='inferred model, true rates ($c=0.1$)')
#    plt.scatter(true_val, df_slice['trueRates_c1.0_treelength']/n_branch, label='c=1.0 (true rates)')
    ...
    plt.scatter(true_val, df_slice['inferred_c0.1_depth'], label='inferred model ($c=0.1$)')
    # plt.scatter(true_val, df_slice['inferred_c1.0_depth'], label='c=1.0')
    plt.scatter(true_val, df_slice['trueRates_c0.1_depth'], label='inferred model, true rates ($c=0.1$)')
