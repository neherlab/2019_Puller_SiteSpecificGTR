...
labels = {'naive':"Alignment frequencies", "dressed":"True counts", "regular":"reconstructed", "marginal":"ancestral sum"}
...
if __name__ == '__main__':
    ...
    L=300
    data, n_vals, mu_vals = load_toy_data_results('2019-01-01_simulated_data_JC_results/')

    ####
    plot_pdist_vs_tree_length(data, n_vals, mu_vals, methods=['naive', 'dressed'],
                        fname='figures/p_dist_vs_treelength')
    plot_avg_rate(data, n_vals, mu_vals, methods=['dressed'],
                        fname='figures/avg_rate_dressed')

    ####
    plot_pdist_vs_rtt(data, [3000], mu_vals, methods=['naive', 'dressed', 'regular', 'marginal'],
                      fname='figures/p_dist_vs_rtt')

    plot_site_specific_rate_dist(data, [3000], mu_vals, methods=['naive', 'dressed', 'regular', 'marginal'],
