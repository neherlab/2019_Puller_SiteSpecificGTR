...
\begin{figure*}[htb]
	...
	(B) The relative substitution rates are accurately inferred as soon as the typical site experiences several substitutions across the tree as quantified here as Pearson correlation coefficient between true and inferred rates. Regularization via pseudo-counts reduces over-fitting at low divergence. Data in this figure uses was generated assuming Gamma distributed rate variation with $\alpha=1.5$. }
	\label{fig:dressed}
\end{figure*}
...
Deviations of the scaling $\chi_2\sim 1/\textrm{tree length}$ are due to rate variation.
The data shown in Fig.~\ref{fig:reconstructed}, assumes that rates are Gamma distributed with $\alpha=1.5$ and variation in inference accuracy due to rate variation increases the average error.
Increasing $\alpha$ to 3 improves this scaling.
...
\begin{figure*}[tb]
	\centering
	\includegraphics[width=0.48\textwidth]{{../figures/nuc_length_n300}.pdf}
	\includegraphics[width=0.48\textwidth]{{../figures/nuc_depth_n300}.pdf}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.48\textwidth]{{../figures/model_deviation_n300}.pdf}
