...
Model inference from reconstructed data is accurate if the root to tip distance is small but rapidly looses accuracy if sequences are very diverged.

\begin{figure}[tb]
	\centering
	\includegraphics[width=0.48\textwidth]{../figures/p_dist_vs_rtt.pdf}
	\caption{At large root-to-tip distances, ancestral reconstruction becomes less and less accurate and estimation of equilibrium state frequencies fails. }
